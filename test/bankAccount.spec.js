...
const bankAccountWithStubbedRepo = new BankAccount(operationRepositoryStub, operationPrinter);
const bankAccountWitRepo = new BankAccount(operationRepository, operationPrinter);
...
describe('BankAccount', () => {
  ...
  it('should accept a deposit when the amount is positive and superior or equal to the account balance', () => {
    ...
    bankAccountWithStubbedRepo.deposit(1000);
  ...
  it('should properly set the new account balance when deposit amount is valid', () => {
    ...
    bankAccountWitRepo.deposit(1000);
    const operationsToCheck = bankAccountWitRepo.getBalanceHistory();
  ...
  it('should properly set the new account balance when withdrawal amount is valid', () => {
    ...
    bankAccountWitRepo.withdraw(150);
    const operationsToCheck = bankAccountWitRepo.getBalanceHistory();
  ...
  it('should accept a withdrawal when the amount is positive and inferior or equal to the account balance', () => {
    ...
    bankAccountWithStubbedRepo.withdraw(1000);
  ...
  it('should print a statement', () => {
    ...
    bankAccountWithStubbedRepo.printOperations();
